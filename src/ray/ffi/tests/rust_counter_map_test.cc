...
// Rust FFI tests for CounterMap.
// Matches: src/ray/util/tests/counter_test.cc

#include "gtest/gtest.h"
#include "ray/ffi/rust_counter_map.h"

#include <string>

namespace ray {

class RustCounterMapTest : public ::testing::Test {};

TEST_F(RustCounterMapTest, TestBasic) {
  auto c = RustCounterMap();
  c.Increment("k1");
  c.Increment("k1");
  c.Increment("k2");
...
TEST_F(RustCounterMapTest, TestCallback) {
  auto c = RustCounterMap();
  int num_calls = 0;
...
TEST_F(RustCounterMapTest, TestIterate) {
  auto c = RustCounterMap();
  int num_keys = 0;
  c.Increment("k1");
  c.Increment("k1");
